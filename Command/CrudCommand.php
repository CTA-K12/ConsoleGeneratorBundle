 ...
 */
class CrudCommand extends GenerateDoctrineCommand
{
    private $generator;
    ...
    protected function configure()
    {
        $this
            ->setDefinition(array(
                ...
                new InputOption('no-write', '', InputOption::VALUE_NONE, 'Whether or not to generate create, new and delete actions'),
            ...
            ->setDescription('Generates CRUD controllers and routes based on a Doctrine entity')
            ->setHelp(<<<EOT
The <info>mesd:crud</info> command generates a CRUD based on a Doctrine entity.

The default command generates all write and show actions.

<info>php app/console mesd:crud --entity=AcmeBlogBundle:Post --route-prefix=post_admin</info>

Using the --no-write option disables generation of the new, edit and delete actions.

<info>php app/console mesd:crud --entity=AcmeBlogBundle:Post --route-prefix=post_admin --no-write</info>
EOT
            )
            ->setName('mesd:crud')
        ;
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $withWrite = $input->getOption('no-write');
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        // write?
        $withWrite = $input->getOption('no-write') ? true : false;
        $output->writeln(array(
            '',
        ...
        $withWrite = $dialog->askConfirmation($output, $dialog->getQuestion('Do you want to generate the "write" actions', $withWrite ? 'no' : 'yes', '?'), $withWrite);
        $input->setOption('no-write', $withWrite);
