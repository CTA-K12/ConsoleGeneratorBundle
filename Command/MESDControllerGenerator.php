...
class MESDControllerGenerator extends Generator
{
    ...
    private function generateControllerClass()
    {
        ...
        $this->renderFile($this->skeletonDir, 'controller/controller.php.twig', $target, array(
            'actions'           => $this->actions,
            'route_prefix'      => $this->routePrefix,
            'route_name_prefix' => $this->routeNamePrefix,
    ...
    private function generateTestClass()
    {
        ...
        $this->renderFile($this->skeletonDir, 'tests/controllerTest.php.twig', $target, array(
            'route_prefix'      => $this->routePrefix,
            'route_name_prefix' => $this->routeNamePrefix,
            'entity'            => $this->entity,
            'entity_class'      => $entityClass,
