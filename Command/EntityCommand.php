 ...
 */
class EntityCommand extends DoctrineCommand
{
    /**
     * {@inheritDoc}
     */
    protected function configure()
    {
        $this
            ...
            ->setHelp(<<<EOT
The <info>mesd:entity</info> command generates entity classes
...
* To a bundle:
  ...
  <info>php app/console mesd:entity MyCustomBundle</info>

* To a single entity:

  <info>php app/console mesd:entity MyCustomBundle:User</info>
  <info>php app/console mesd:entity MyCustomBundle/Entity/User</info>

* To a namespace

  <info>php app/console mesd:entity MyCustomBundle/Entity</info>
...
you must provide the <comment>--path</comment> option:
  ...
  <info>php app/console mesd:entity Blog/Entity --path=src/</info>
...
pass the <comment>--no-backup</comment> option:
  ...
  <info>php app/console mesd:entity Blog/Entity --no-backup</info>
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach ($metadata->getMetadata() as $m) {
            ...
            if ($m->customRepositoryClassName && false !== strpos($m->customRepositoryClassName, $metadata->getNamespace())) {
                $repoGenerator->writeEntityRepositoryClass($m->customRepositoryClassName, $metadata->getPath(), $output);
            } else {
                $repoGenerator->writeEntityRepositoryClass($m->name, $metadata->getPath(), $output);
            }
        }
    }
